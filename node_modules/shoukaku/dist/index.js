...
__export(index_exports, {
  ...
  Events: () => Events,
  LavalinkOpCodes: () => LavalinkOpCodes,
  LoadType: () => LoadType,
  Node: () => Node,
  Player: () => Player,
  ...
  createDiscordJSOptions: () => createDiscordJSOptions,
  createErisOptions: () => createErisOptions,
  createOceanicOptions: () => createOceanicOptions,
  createSeyfertOptions: () => createSeyfertOptions
});
...
var Connection = class extends import_node_events2.EventEmitter {
  /**
  ...
  async connect() {
    ...
    try {
      const [status] = await (0, import_node_events2.once)(this, "connectionUpdate", { signal: controller.signal });
...
var Node = class {
  ...
  async connect() {
    ...
    const createConnection = () => {
      ...
      const server = new import_ws.default(url.toString(), { headers });
      const cleanup = () => {
        server.onopen = null;
        server.onclose = null;
        server.onerror = null;
